...
##**************************Initailizing Session State***************************************

WELCOME_MSG="HI ! How can i helo you"
        ...
        if not groq_client:
             ...
             try:
                ...
                messages=[
                            ...
                            temperature=0,
                            max_tokens=2500   # stays under the account's output-token-per-minute limit
                )
                ...
                if "<think>" in raw_answer and "</think>" in raw_answer:
                    ...
                    # This removes the opening tag, closing tag, and everything inside them
                ...
                # Fallback safeguard: if only the closing tag is found
                  ...
                  answer = f"⚠️ You Have reached your Limit, Try After Some Time"
...
with image_tab:
     ...
     img_box=st.container(height=350)
     with img_box:
